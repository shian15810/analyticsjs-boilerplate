 ...
 */
let TRACKING_VERSION = '1';


let TRACKING_TIME_ZONE = 'America/Los_Angeles';


const analytics = ({GA = TRACKING_ID_GA, FB = TRACKING_ID_FB, TV = TRACKING_VERSION, TZ = TRACKING_TIME_ZONE}) => {
  ...
  return {init, trackError, trackEvent, trackPageview};
};
